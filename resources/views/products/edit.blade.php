            ...
            <div class="col align-self-center">
                <form method="POST" action="{{ route('students.update', $student->id) }}">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="number" name="age" value="{{ old('age', $student->age) }}" id="age" class="form-control bg-transparent text-white" required>
                    </div>

                    <button type="submit" class="btn btn-success mt-1 pe-3 ps-3">Update</button>
